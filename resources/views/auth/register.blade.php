                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="password_confirmation" type="password" class="form-control" placeholder="Confirmar senha" required>
                                ...
                                <div class="form-check text-left">
                                    <label class="form-check-label">
                                        ...
                                        <span class="form-check-sign"></span>
                                            {{ __('Eu aceito os') }}
                                        <a href="#something">{{ __('termos e as condiçoes') }}</a>.
                                    </label>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Registrar') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
