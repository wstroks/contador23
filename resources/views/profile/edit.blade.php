    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="center col-md-12 text-center">
                <form class="center col-md-12" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Editar Perfil de Administrador') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                ...
                <form class="col-md-12" action="{{ route('profile.password') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Muda Senha') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Senha Nova') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
